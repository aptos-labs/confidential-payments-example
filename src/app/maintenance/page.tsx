...
export default function MaintenancePage() {
  return (
    <section className='relative flex size-full items-center justify-center overflow-hidden bg-backgroundPrimary'>
      <div className='z-30 mx-auto max-w-screen-md px-4 py-8 text-center lg:px-12 lg:py-16'>
        <svg
